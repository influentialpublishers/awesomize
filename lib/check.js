...
, MAXIMUM_LENGTH_EXCEEDED: 'maxium_length_exceeded'
...
// _isGraterThanMax = Integer -> String -> Bool
const _isAtLeastMin = _.curry((min, text) => _.compose(
  _.lte(min),
  _.length
)(text))

// maxLength = Integer -> String -> Maybe String
const minLength = basic(_isAtLeastMin, MSG.MINIMUM_LENGTH_NOT_MET)

// _isLessThanMax = Integer -> String -> Bool
const _isLessThanMax = _.curry((max, text) => _.compose(
  _.gte(max),
  _.length
)(text))

// maxLength = Integer -> String -> Maybe String
const maxLength = basic(_isLessThanMax, MSG.MAXIMUM_LENGTH_EXCEEDED)

// _isEqualTo = String -> Value -> Object -> Maybe String
const _isEqualTo = _.curry((key, value, obj) => _.propEq(key, value)(obj))

// isEqualTo = String -> Value, Object -> Maybe String
const isEqualTo = basic(_isEqualTo, MSG.DOES_NOT_MATCH)
